    ...
    >
      <h2 className="text-2xl font-extrabold flex items-center gap-2  text-orange-500 p-4">
        ...
        <RxCross2
          ...
          className=" bg-indigo-500 rounded-sm font-bold text-white cursor-pointer"
          size={25}
        />
      </h2>
              ...
              <li className="p-2">
                ...
                >
                  <div className=" flex items-center justify-between">
                    ...
                    {isSubCategoryOpen ? <FaAngleUp /> : <FaAngleDown />}
                  </div>
                </div>
                {isSubCategoryOpen && (
                  <ul className="ml-2">
                    <li className="p-2">
                      <Link to="/dashboard/subcategory-list/" className="block">
                        {" "}
                        <span className=" flex items-center gap-2 text-sm font-medium">
                          <BiSolidPyramid
                            className=" text-indigo-500"
                    ...
                    <li className="p-2">
                      <Link to="/dashboard/create-subcategory/" className="block">
                        <span className=" flex items-center gap-2 text-sm font-medium">
                          <BiSolidPyramid
                            className=" text-indigo-500"
                            size={20}
