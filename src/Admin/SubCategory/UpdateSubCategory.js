...
const UpdateSubCategory = () => {
  ...
  const getSubCategory = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/api/category/get-subcategory/${params.id}/`);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/api/category/update-subcategory/${params.id}/`, {
        method: 'PUT',
        headers: {
