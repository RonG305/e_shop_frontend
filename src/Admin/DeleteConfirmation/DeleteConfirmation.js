const DeleteConfirmation = ({ setIsModalOpen, deleteProduct, productId}) => {
  return (
    <div className=' rounded-md md:w-1/3 absolute top-10 bg-slate-200 p-4 border border-slate-200'>
